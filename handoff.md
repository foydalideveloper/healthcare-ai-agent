...
2. **Deferred (from `handoff_2026-06-02.md` §5 — not active):**
   ...
   - **🔜 Self-Improvement Job 3: LoRA fine-tuning of local Gemma 4 26B A4B** using Job 2's dataset — Korean financial + lifelog specialization. Goal: local Gemma matches Gemini 3.1 Pro quality on target content; production switch to the fine-tuned local primary arm cuts cloud cost ~80%. Est. 12–16 h after Job 2. (added 2026-06-05.)
